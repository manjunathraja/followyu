...
public class UIHelper {
    ...
    public static String getDisplayJid(final Jid jid) {
        if (jid == null) {
            return "";
        } else {
            final String displayPhoneFormat =
                    PhoneHelper.getValidINInternationalPhoneFormat(
                            jid.toBareJid().toString().split("[@.]")[0]);
            if (displayPhoneFormat == null) {
                return jid.toBareJid().toString().split("[@.]")[0];
            } else {
                return displayPhoneFormat;
            }
        }
    }

    public static void ErrorAlert(Context context, int title, int message) {
    ...
    public static void ToastAlert(Context context, int message) {
