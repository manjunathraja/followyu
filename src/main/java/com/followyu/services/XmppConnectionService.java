...
import com.followyu.entities.Blockable;
import com.followyu.entities.Bookmark;
import com.followyu.entities.Contact;
import com.followyu.entities.Conversation;
import com.followyu.entities.Downloadable;
import com.followyu.entities.DownloadablePlaceholder;
import com.followyu.entities.Message;
import com.followyu.entities.MucOptions;
import com.followyu.entities.MucOptions.OnRenameListener;
import com.followyu.entities.Presences;
import com.followyu.generator.IqGenerator;
import com.followyu.generator.MessageGenerator;
import com.followyu.generator.PresenceGenerator;
import com.followyu.http.HttpConnectionManager;
import com.followyu.parser.IqParser;
import com.followyu.parser.MessageParser;
import com.followyu.parser.PresenceParser;
import com.followyu.persistance.DatabaseBackend;
import com.followyu.persistance.FileBackend;
import com.followyu.ui.StartConversationActivity;
import com.followyu.ui.UiCallback;
import com.followyu.utils.CryptoHelper;
import com.followyu.utils.ExceptionHelper;
import com.followyu.utils.OnPhoneContactsLoadedListener;
import com.followyu.utils.PRNGFixes;
import com.followyu.utils.PhoneHelper;
import com.followyu.utils.UIHelper;
import com.followyu.utils.Xmlns;
import com.followyu.xml.Element;
import com.followyu.xmpp.OnBindListener;
import com.followyu.xmpp.OnContactStatusChanged;
import com.followyu.xmpp.OnIqPacketReceived;
import com.followyu.xmpp.OnMessageAcknowledged;
import com.followyu.xmpp.OnMessagePacketReceived;
import com.followyu.xmpp.OnPresencePacketReceived;
import com.followyu.xmpp.OnStatusChanged;
import com.followyu.xmpp.OnUpdateBlocklist;
import com.followyu.xmpp.XmppConnection;
import com.followyu.xmpp.chatstate.ChatState;
import com.followyu.xmpp.forms.Data;
import com.followyu.xmpp.forms.Field;
import com.followyu.xmpp.jid.InvalidJidException;
import com.followyu.xmpp.jid.Jid;
import com.followyu.xmpp.jingle.JingleConnectionManager;
import com.followyu.xmpp.jingle.OnJinglePacketReceived;
...
public class XmppConnectionService extends Service implements OnPhoneContactsLoadedListener {
    ...
    private boolean syncContactsWithServer = false;
	private ContentObserver contactObserver = new ContentObserver(null) {
		@Override
		public void onChange(boolean selfChange) {
			super.onChange(selfChange);
            syncContactsWithServer = false;
				...
				if (!hasInternetConnection()) {
					...
					if (account.getStatus() == Account.State.ONLINE) {
						...
						if (account.getXmppConnection().getTimeToNextAttempt() <= 0) {
                            if ((account.getStatus() != Account.State.UNAUTHORIZED) &&
                                    (account.getStatus() != Account.State.REGISTRATION_FAILED) &&
                                    (account.getStatus() != Account.State.REGISTRATION_CONFLICT)) {
                                Log.d(Config.LOGTAG, account.getJid() + ": Reconnecting...");
                                reconnectAccount(account, true);
                            } else {
                                Log.d(Config.LOGTAG, account.getJid() + ": Not Reconnecting...");
                            }
						}
					}
	...
	public void onPhoneContactsLoaded(final List<Bundle> phoneContacts) {
        ...
        //UIHelper.ToastAlert(XmppConnectionService.this, R.string.toast_message_sync_contacts);
        mPhoneContactMergerThread = new Thread(new Runnable() {
			@Override
			public void run() {
				Log.d(Config.LOGTAG,"start merging phone contacts with roster");
                if (syncContactsWithServer) {
                } else {
                }
				for (Account account : accounts) {
					...
					for (Bundle phoneContact : phoneContacts) {
                        ...
                        Jid jid;
                        try {
                            jid = Jid.fromString(phoneContact.getString("jid") + Config.SERVER_HOST);
                        } catch (final InvalidJidException e) {
                            continue;
                        }
                        if (account.getRoster().isContactExit(jid)) {
                        ...
                        } else if (syncContactsWithServer) {
                        }
                    }
                }
	...
	public Conversation findOrCreateConversation(final Account account, final Jid jid_p, final boolean muc, final MessageArchiveService.Query query) {
		synchronized (this.conversations) {
            Jid jid = jid_p;
	...
	protected void syncDirtyContacts(Account account) {
        ...
        if ((findContacts(account.getJid()).size() == 0) &&
    ...
    //NOTE: This might be usefull at some point to have Async Contact Sync..
    class AddRegContactTask extends AsyncTask<String, Void, String> {
        private final WeakReference<Account> AccountReference;
        private String phone = null;

        public AddRegContactTask(Account account) {
            AccountReference = new WeakReference<>(account);
        }

        @Override
        protected String doInBackground(String... params) {
            phone = params[0];
            //getRegisterdContactDetails(AccountReference.get(), phone);
            //initContactSearch(AccountReference.get(), phone);
            return "jid@jabberxmpp.com";
        }
    ...
    class SyncContactsWithServerTask extends AsyncTask<Void, Void, Void> {
    ...
    public void syncContacts(boolean syncWithServer) {
        final SyncContactsWithServerTask syncContactsTask = new SyncContactsWithServerTask();
        syncContactsWithServer = syncWithServer;
