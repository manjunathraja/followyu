...
import com.followyu.entities.ListItem;
...
import com.followyu.ui.adapter.ListItemAdapter;
import com.followyu.utils.XmppUri;
...
public class StartConversationActivity extends XmppActivity implements OnRosterUpdate, OnUpdateBlocklist {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mViewPager.setAdapter(new FragmentPagerAdapter(getFragmentManager()) {
			...
			public int getCount() {
				return 1;
			}//KRHM it should be 2 for conferences
	...
	protected void showCreateContactDialog(final String prefilledJid, final String fingerprint) {
        ...
        final EditText contactPhoneNo = (EditText) dialogView.findViewById(R.id.contact_phone_number);
		...
		dialog.show();
        UIHelper.ToastAlert(StartConversationActivity.this, R.string.toast_message_sync_phone_contacts);
		dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(final View v) {
                        ...
                        final String validContactPhoneNo =
                                PhoneHelper.getValidINE164PhoneFormat(contactPhoneNo.getText().toString());
                        if (validContactPhoneNo == null) {
                            contactPhoneNo.setError(getString(R.string.invalid_phone_number));
                            return;
                        }
                        StringBuilder ContactRawJid = new StringBuilder();
                        ContactRawJid.append(validContactPhoneNo).append(Config.SERVER_HOST);
                        jid.setText(ContactRawJid.toString());
						...
						if (contact.showInRoster()) {
							contactPhoneNo.setError(getString(R.string.contact_already_exists));
						} else {
							contact.addOtrFingerprint(fingerprint);
                            xmppConnectionService.addContactService(account, validContactPhoneNo.toString());
	...
	public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem menuSyncContacts = menu.findItem(R.id.action_sync_contacts);
    ...
    private void syncContacts() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setNegativeButton(R.string.cancel, null);
        builder.setTitle(R.string.action_sync_contacts);
        builder.setMessage(getString(R.string.sync_contact_message));
        builder.setPositiveButton(R.string.ok, new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                xmppConnectionService.syncContacts(true);
            }
        });
        builder.create().show();
    }

    public void showInvalidContact() {
        UIHelper.ToastAlert(StartConversationActivity.this, R.string.toast_message_invalid_contact);
    }
}
