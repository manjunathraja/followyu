...
public class CountryAdapter extends BaseAdapter {
    ...
    public CountryAdapter(Context context, int viewId, int dropdownViewId) {
        this(context, new ArrayList<CountryCode>(), viewId, dropdownViewId);
    }

    public CountryAdapter(Context context, List<CountryCode> data, int viewId, int dropdownViewId) {
    ...
    public void add(String regionCode) {
        ...
        cc.regionName = this.getRegionDisplayName(regionCode, Locale.getDefault());
        mData.add(cc);
    }
