...
import com.followyu.services.AvatarService;
import com.followyu.services.XmppConnectionService;
import com.followyu.services.XmppConnectionService.XmppConnectionBinder;
...
public abstract class XmppActivity extends Activity {
	...
	protected void showAddToRosterDialog(final Contact contact) {
        ...
        builder.setTitle(UIHelper.getDisplayJid(contact.getJid()));
				...
				public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
					return new NdefMessage(new NdefRecord[]{
						NdefRecord.createUri(getShareableUri()),
							NdefRecord.createApplicationRecord("com.followyu")
					});
				}
			}, this);
		}
	...
	protected int findTheme() {
		if (getPreferences().getBoolean("use_larger_font", false)) {
			return R.style.FollowYuTheme_LargerText;
		} else {
			return R.style.FollowYuTheme;
		}
	}
