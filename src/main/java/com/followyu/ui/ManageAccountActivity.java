...
import com.followyu.ui.adapter.AccountAdapter;
...
public class ManageAccountActivity extends XmppActivity implements OnAccountUpdate {
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        //final String[] account_jid  = this.selectedAccount.getJid().toBareJid().toString().split("[@.]");
		//menu.setHeaderTitle(account_jid[0]);
	}
