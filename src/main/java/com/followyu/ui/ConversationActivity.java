...
import com.followyu.services.XmppConnectionService.OnConversationUpdate;
import com.followyu.services.XmppConnectionService.OnRosterUpdate;
import com.followyu.ui.adapter.ConversationAdapter;
import com.followyu.utils.ExceptionHelper;
import com.followyu.utils.UIHelper;
import com.followyu.xmpp.OnUpdateBlocklist;
import com.followyu.utils.DeviceDimentionsHelper;

public class ConversationActivity extends XmppActivity
	implements OnAccountUpdate, OnConversationUpdate, OnRosterUpdate, OnUpdateBlocklist {

	public static final String ACTION_DOWNLOAD = "com.followyu.action.DOWNLOAD";
	...
	public void showConversationsOverview() {
        ...
        /*if (conversationList.size() == 0) {
            UIHelper.ToastAlert(ConversationActivity.this, R.string.toast_message_tap_new);
        }*/
	}
	...
	protected void onCreate(final Bundle savedInstanceState) {
        ...
        /*
        int screenHeight = DeviceDimentionsHelper.getDisplayHeight(this);
        int screenWidth = DeviceDimentionsHelper.getDisplayWidth(this);
        LinearLayout layout = (LinearLayout)findViewById(R.id.followyu_home);
        layout.getLayoutParams().width = (int)DeviceDimentionsHelper.convertPixelsToDp((float)screenWidth, this);
        int widthdp = (int)DeviceDimentionsHelper.convertPixelsToDp((float)screenWidth, this);
        Log.d(Config.LOGTAG, "Height: " + screenHeight + "Width: " + screenWidth + "widthdp: " + widthdp);
        */
        ...
        LinearLayout layout = (LinearLayout)findViewById(R.id.followyu_home);
        layout.getLayoutParams().width = screenWidthDp;
        */
			...
			mSlidingPaneLayout.setPanelSlideListener(new PanelSlideListener() {
				...
				public void onPanelClosed(View arg0) {
                    if (conversationList.size() > 0) {
                        ...
                        //UIHelper.ToastAlert(ConversationActivity.this, R.string.toast_message_no_conversations);
	...
	private void selectPresenceToAttachFile(final int attachmentChoice, final int encryption) {
		if (attachmentChoice == ATTACHMENT_CHOICE_LOCATION && encryption != Message.ENCRYPTION_OTR) {
			...
			Intent intent = new Intent("com.followyu.location.request");
				...
				public void onPresenceSelected() {
					...
					switch (attachmentChoice) {
						...
						case ATTACHMENT_CHOICE_LOCATION:
							intent.setAction("com.followyu.location.request");
							break;
					}
		...
		if (item.getItemId() == android.R.id.home) {
			...
			switch (item.getItemId()) {
				case R.id.action_attach_file:
                    if (getSelectedConversation().mSecureConversation) {
                        UIHelper.ToastAlert(ConversationActivity.this, R.string.toast_message_no_attach_support);
                    } else {
                        attachFileDialog();
                    }
					break;
	...
	protected void attachFileDialog() {
		...
		if (new Intent("com.followyu.location.request").resolveActivity(getPackageManager()) == null) {
	...
	void onBackendConnected() {
		this.xmppConnectionService.getNotificationService().setIsInForeground(true);
		updateConversationList();
        //Log.d(Config.LOGTAG, "onBackendConnected: ConversationActivity");
